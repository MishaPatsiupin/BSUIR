    ...
    do {
        ...
        switch(ch) {
            case 'p' : {
                ...
                pthread_create(&pthread_producer, NULL, producer_wrapper, NULL);
                push_list(&list_of_ptreads, pthread_producer, 'P');
                break;
            }
            case 'c' : {
                pthread_t pthread_consumer;
                pthread_create(&pthread_consumer, NULL, consumer_wrapper, NULL);
            ...
            case 'k' : {
                ...
                if (erase_list(&list_of_ptreads, num, &pthread_id)) pthread_cancel(pthread_id);
                break;
            }
            case '+' : {
