...
anchors.horizontalCenter: parent.horizontalCenter
                placeholderText: "Введите количество строк 1й матрицы:"
                onTextChanged: {
            ...
            TextField {
                ...
                width: parent.width * 0.8
anchors.horizontalCenter: parent.horizontalCenter
                placeholderText: "Введите количество столбцов 1й матрицы:"
                onTextChanged: {
                    var value = parseInt(text);
                    if (value > 5) {
                        value = 5;
            ...
            TextField {
                ...
                width: parent.width * 0.8
                anchors.horizontalCenter: parent.horizontalCenter
                placeholderText: "Введите количество столбцов 2й матрицы:"
                onTextChanged: {
                    var value = parseInt(text);
                    if (value > 5) {
                        value = 5;
...
chek_input_size = 1
            ...
            Label {
                text: "Результат сложения матриц:"
